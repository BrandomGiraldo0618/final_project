        ...
        <div class="col-5 shadow p-3 mb-5 bg-body rounded mt-2">
            <table class="table table-hover">
                <thead>
                    ...
                    <th class="table-light border">EMAIL</th>
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="border">
                                <a class="btn btn-info" style="padding: 5px" href="/users/{{$user->id}}/edit">
                            ...
                            <td class="border">
                                <form method="POST" action="/users/{{$user->id}}">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-danger" style="padding: 5px" onclick="return confirm('Are you sure to remove {{$user->name}}?')">
